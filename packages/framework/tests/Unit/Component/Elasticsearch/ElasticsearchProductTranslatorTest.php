...
use Shopsys\FrameworkBundle\Model\Product\Elasticsearch\ElasticsearchProductTranslator;

class ElasticsearchProductTranslatorTest extends TestCase
{
    public function testTranslation(): void
    {
        $translator = new ElasticsearchProductTranslator();

        $data = $this->createData();
        $expected = $this->createExpected();

        $result = $translator->translateBulk('1', $data);
