...
class OverridePhpConstantsWebpackPlugin {

    /**
     * OverridePhpConstantsWebpackPlugin - A wrapper for sw-precache to use with webpack
     * @constructor
    ...
    apply (compiler) {
        ...
        function fileWalker (dirs, done) {
            ...
            Promise.all(promises).then(allFilepaths => {
                ...
                done(concatedFilePaths);
            });
        }

        fileWalker('./assets/js/**/*.js', (err, filePaths) => {
            console.log(err);
...
module.exports = OverridePhpConstantsWebpackPlugin;
